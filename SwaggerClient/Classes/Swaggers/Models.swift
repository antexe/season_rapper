...
class Decoders {
    ...
    private static var __once: () = {
        ...
        Decoders.addDecoder(clazz: [InlineResponse500].self) { (source: AnyObject) -> [InlineResponse500] in
        ...
        Decoders.addDecoder(clazz: InlineResponse500.self) { (source: AnyObject) -> InlineResponse500 in
            ...
            let instance = InlineResponse500()
        ...
        // Decoder for [Sound]
        Decoders.addDecoder(clazz: [Sound].self) { (source: AnyObject) -> [Sound] in
            return Decoders.decode(clazz: [Sound].self, source: source)
        }
        // Decoder for Sound
        Decoders.addDecoder(clazz: Sound.self) { (source: AnyObject) -> Sound in
            ...
            fatalError("Source \(source) is not convertible to typealias Sound: Maybe swagger file is insufficient")
        }
    }()
